%% Apply tissue masks to CAA segmentation volumes
% Author: Mack Hyman
% Date Created: Nov. 25, 2024
%
% Detailed Description
%{
- Import the segmentations (.nii)
- Import the tissue masks (.nii)
- Apply tissue mask
...
% Output filename
output_names = {'caa6_frontal_vessels_unet_masked',...
          'caa6_occipital_vessels_unet_masked',...
          'caa17_occipital_vessels_unet_masked',...
          'caa22_occipital_vessels_unet_masked',...
          'caa25_frontal_vessels_unet_masked',...
          'caa25_occipital_vessels_unet_masked',...
          'caa26_frontal_vessels_unet_masked',...
          'caa26_occipital_vessels_unet_masked'};
