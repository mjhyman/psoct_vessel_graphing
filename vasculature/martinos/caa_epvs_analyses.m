%% Examine optical properties of parenchymal tissue
% Author: Mack Hyman
...
%{
- Import the EPVS
- Import masked vasculature
- Import tissue optical properties
- Examine optical properties around EPVS:
    - dilate epvs about the axis
    - measure the retardance, scattering, birefringence
- Examine optical properties around vessel without EPVS:
    - follow same procedure but using a vessel without EPVS
%}
